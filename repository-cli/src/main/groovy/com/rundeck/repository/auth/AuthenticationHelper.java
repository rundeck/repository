package com.rundeck.repository.auth;
...
public class AuthenticationHelper {
    ...
    AuthenticationHelper(String userPoolID, String clientid, String region, String secretKey) {
        do {
     ...
     */
    AuthenticationResultType doSRPAuthentication(String username, String password) {
     ...
     *
     * @param challenge The authentication challenge returned from the cognito user pool
